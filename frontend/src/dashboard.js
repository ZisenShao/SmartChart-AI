  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="toggle-container">
        <div className={`toggle-switch ${isFriendlyMode ? "friendly" : "default"}`}>
      ...
      <h1 className="clinical-notes-heading">Clinical Notes</h1>

      {/* Patient Information */}
      <div className="patient-info">
        <p>
          <img src={person} alt="Person Icon" className="icon" />
          <span>Patient Name:</span> John Davis
        </p>
        <p>
          <img src={stethoscope} alt="Stethoscope Icon" className="icon" />
          <span>Date of Visit:</span> 09/30/2024
        </p>
        <p>
          <img src={stethoscope} alt="Provider Icon" className="icon" />
          <span>Provider:</span> Dr. Jane Smith, Cardiologist
        </p>
      </div>
